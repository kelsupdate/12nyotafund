    ...
    <div className="bg-gradient-to-br from-white via-[#37B9C7]/50 to-red-50 min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-12">
        <div className="bg-white/80 backdrop-blur-md p-10 rounded-2xl shadow-xl border border-gray-100 text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-[#37B9C7] mx-auto mb-6"></div>
          <h2 className="text-2xl font-bold text-[#37B9C7] mb-4">Checking Eligibility</h2>
          <p className="text-gray-600 mb-4">Please wait while we verify your information with CRB...</p>
          <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
            <div
              className="bg-gradient-to-r from-[#37B9C7] to-red-500 h-2 rounded-full transition-all duration-300"
